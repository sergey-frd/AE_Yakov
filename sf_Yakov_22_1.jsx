...
function main() 
{
    ...
    genXml = readXmlaeGenXml("e:\\Git\\P_h_o_t_o\\AE_JSX\\AE_Yakov\\xml\\gen_Yakov_22_baby_1.xml");
    ...
    var compFinalName = "aeFinalYakov_babyAll_1";
    finalComp = handleFinalCompAll(compFinalName);
    
    var compFinalName = "aeFinalYakov_baby_1";
    finalComp = handleFinalComp4(compFinalName);
    
    var compFinalName = "aeFinalYakov_babyBaseBg_1";
    finalComp = handleFinalCompBaseBg(compFinalName);
    
    var compFinalName = "aeFinalYakov_babyBg_1";
    finalComp = handleFinalCompBg(compFinalName);
    
    
    var compFinalName = "aeFinalYakov_babyBase_1";
    finalComp = handleFinalCompBase(compFinalName);
    
    
    var compFinalName = "aeFinalYakov_babyBaseBi_1";
