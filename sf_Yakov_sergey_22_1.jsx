...
function main() 
{
    ...
    genXml = readXmlaeGenXml("e:\\Git\\P_h_o_t_o\\AE_JSX\\AE_Yakov\\xml\\gen_Yakov_22_sergey_1.xml");
    ...
    var compFinalName = "aeFinalYakov_sergeyAll_1";
    finalComp = handleFinalCompAll(compFinalName);
    
    var compFinalName = "aeFinalYakov_sergey_1";
    finalComp = handleFinalComp4(compFinalName);
    
    var compFinalName = "aeFinalYakov_sergeyBaseBg_1";
    finalComp = handleFinalCompBaseBg(compFinalName);
    
    var compFinalName = "aeFinalYakov_sergeyBg_1";
    finalComp = handleFinalCompBg(compFinalName);
    
    
    var compFinalName = "aeFinalYakov_sergeyBase_1";
    finalComp = handleFinalCompBase(compFinalName);
    
    
    var compFinalName = "aeFinalYakov_sergeyBaseBi_1";
