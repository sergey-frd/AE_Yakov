...
function main() 
{
    ...
    genXml = readXmlaeGenXml("e:\\Git\\P_h_o_t_o\\AE_JSX\\AE_Yakov\\xml\\gen_Yakov_22_dima_1.xml");
    ...
    var compFinalName = "aeFinalYakov_dimaAll_1";
    finalComp = handleFinalCompAll(compFinalName);
    
    var compFinalName = "aeFinalYakov_dima_1";
    finalComp = handleFinalComp4(compFinalName);
    
    var compFinalName = "aeFinalYakov_dimaBaseBg_1";
    finalComp = handleFinalCompBaseBg(compFinalName);
    
    var compFinalName = "aeFinalYakov_dimaBg_1";
    finalComp = handleFinalCompBg(compFinalName);
    
    
    var compFinalName = "aeFinalYakov_dimaBase_1";
    finalComp = handleFinalCompBase(compFinalName);
    
    
    var compFinalName = "aeFinalYakov_dimaBaseBi_1";
