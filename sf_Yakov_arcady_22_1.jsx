...
function main() 
{
    ...
    genXml = readXmlaeGenXml("e:\\Git\\P_h_o_t_o\\AE_JSX\\AE_Yakov\\xml\\gen_Yakov_22_arcady_1.xml");
    ...
    var compFinalName = "aeFinalYakov_arcadyAll_1";
    finalComp = handleFinalCompAll(compFinalName);
    
    var compFinalName = "aeFinalYakov_arcady_1";
    finalComp = handleFinalComp4(compFinalName);
    
    var compFinalName = "aeFinalYakov_arcadyBaseBg_1";
    finalComp = handleFinalCompBaseBg(compFinalName);
    
    var compFinalName = "aeFinalYakov_arcadyBg_1";
    finalComp = handleFinalCompBg(compFinalName);
    
    
    var compFinalName = "aeFinalYakov_arcadyBase_1";
    finalComp = handleFinalCompBase(compFinalName);
    
    
    var compFinalName = "aeFinalYakov_arcadyBaseBi_1";
