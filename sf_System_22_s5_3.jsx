...
function main() 
{
   ...
   // AAAAAAAAAAAAAAAAAAAAAAAAAAAA
    genXml = readXmlaeGenXml("e:\\Git\\P_h_o_t_o\\AE_JSX\\AE_Yakov\\xml\\gen_System_22_s5.xml");
    ...
    var compFinalName = "aeFinalYakov_22MR_s5_3";
    finalComp = handleFinalCompAll(compFinalName);

    var compFinalName = "aeFinalYakov_22MR_s5_3_ph_a_bg_1";
    finalComp = handleFinalCompAll_Bg(compFinalName);

    var compFinalName = "aeFinalYakov_22MR_s5_3_bg_1";
